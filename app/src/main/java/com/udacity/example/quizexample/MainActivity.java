...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextWord() {
        ...
        if(mData == null) {
            Toast.makeText(this,"Data not loaded yet, please try after sometime",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if(mData.moveToNext()) {
            ...
            mDefinitionTextView.setText(null);
        } else {
            mData.moveToFirst();
            String word = mData.getString(mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD));
            mWordTextView.setText(word);
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            while (cursor.moveToNext()) {
                Log.d(MainActivity.class.getSimpleName(), "Cursor Data -> " + cursor.getString(cursor.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD)) +
                " -> " + cursor.getString(cursor.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION)));
            }
